...
func newSession(db *gorm.DB, opts ...gen.DOOption) session {
	...
	_session.SessionToken = field.NewString(tableName, "sessionToken")
	_session.UserID = field.NewString(tableName, "userId")
	_session.Expires = field.NewTime(tableName, "expires")
...
func (s *session) updateTableName(table string) *session {
	...
	s.SessionToken = field.NewString(table, "sessionToken")
	s.UserID = field.NewString(table, "userId")
	s.Expires = field.NewTime(table, "expires")
...
func (s *session) fillFieldMap() {
	...
	s.fieldMap["sessionToken"] = s.SessionToken
