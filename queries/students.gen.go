...
func newStudent(db *gorm.DB, opts ...gen.DOOption) student {
	...
	_student.StudentEmail = field.NewString(tableName, "studentEmail")
	_student.StudentName = field.NewString(tableName, "studentName")
	_student.ClassroomID = field.NewString(tableName, "classroomId")
...
func (s *student) updateTableName(table string) *student {
	...
	s.StudentEmail = field.NewString(table, "studentEmail")
	s.StudentName = field.NewString(table, "studentName")
	s.ClassroomID = field.NewString(table, "classroomId")
...
func (s *student) fillFieldMap() {
	...
	s.fieldMap["studentEmail"] = s.StudentEmail
	s.fieldMap["studentName"] = s.StudentName
	s.fieldMap["classroomId"] = s.ClassroomID
	s.fieldMap["id"] = s.ID
