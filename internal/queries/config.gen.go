...
func newConfig(db *gorm.DB, opts ...gen.DOOption) config {
	...
	_config.Secretaries = field.NewString(tableName, "secretaries")
	_config.PreferredNames = field.NewString(tableName, "preferredNames")
	_config.ExcludedTeachers = field.NewString(tableName, "excludedTeachers")
	_config.SemesterClassName = field.NewString(tableName, "semesterClassName")
	_config.IsRedisCluster = field.NewBool(tableName, "isRedisCluster")
	_config.CreatedAt = field.NewTime(tableName, "createdAt")
...
type config struct {
	...
	ALL               field.Asterisk
	Secretaries       field.String
	PreferredNames    field.String
	ExcludedTeachers  field.String
	SemesterClassName field.String
	IsRedisCluster    field.Bool
...
func (c *config) updateTableName(table string) *config {
	...
	c.Secretaries = field.NewString(table, "secretaries")
	c.PreferredNames = field.NewString(table, "preferredNames")
	c.ExcludedTeachers = field.NewString(table, "excludedTeachers")
	c.SemesterClassName = field.NewString(table, "semesterClassName")
	c.IsRedisCluster = field.NewBool(table, "isRedisCluster")
...
func (c *config) fillFieldMap() {
	...
	c.fieldMap["secretaries"] = c.Secretaries
	c.fieldMap["preferredNames"] = c.PreferredNames
	c.fieldMap["excludedTeachers"] = c.ExcludedTeachers
	c.fieldMap["semesterClassName"] = c.SemesterClassName
	c.fieldMap["isRedisCluster"] = c.IsRedisCluster
